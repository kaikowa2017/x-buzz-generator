...
CREATE TABLE "new_LearningPattern" (
    ...
    "lifeScore" REAL NOT NULL DEFAULT 1.0,
...
INSERT INTO "new_LearningPattern" ("accountId", "createdAt", "examples", "genreId", "id", "pattern", "source", "strongCount", "updatedAt", "weakCount", "weight") SELECT "accountId", "createdAt", "examples", "genreId", "id", "pattern", "source", "strongCount", "updatedAt", "weakCount", "weight" FROM "LearningPattern";
